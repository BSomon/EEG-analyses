...
function [measure, latlocalpeak, latfracpeak, errorcode] = Peak_localisation(datax, timex, varargin)
...
p.addParamValue('Neighborhood', 2); 
...
p.addParamValue('Peakreplace', 'abs', @ischar); % alterantive amplitude (when no local peak was found)
...
if nsamples<=(2*npoints)
      ...
      disp('Vous n avez pas assez de points.');
      return
end
